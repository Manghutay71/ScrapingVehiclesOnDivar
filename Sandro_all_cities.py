# -*- coding: utf-8 -*-
"""
Created on Sat Oct  8 18:22:14 2022
...
#year = ['1395-1395','1396-1396','1397-1397','1398-1398','1399-1399']

#TehranNeighbourhoods = neighbours_list[neighbours_list['city'] == 'tehran']
#TehranNeighbourhoods = pd.concat([TehranNeighbourhoods, tehran_super_neighbour_list], axis=0)
#TehranNeighbourhoods = TehranNeighbourhoods.reset_index(drop=True)
...
for j in range(253,full_city_list.shape[0]):
    
    address = "https://divar.ir/s/"+str(full_city_list.iloc[j]['city'])+"/car/renault/sandero-stepway/automatic"#+str(TehranNeighbourhoods.iloc[j]['neighbour'])
    ...
    try:
        ...
        df6['city'] = str(full_city_list.iloc[j]['city'])
        df6['point'] = str(full_city_list.iloc[j]['point'])
        df6['province'] = str(full_city_list.iloc[j]['province'])
