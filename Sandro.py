# -*- coding: utf-8 -*-
"""
Created on Fri Oct  7 18:43:15 2022
...
for j in range(0,TehranNeighbourhoods.shape[0]):
    
    address = "https://divar.ir/s/tehran/car/renault/sandero-stepway/automatic/"+str(TehranNeighbourhoods.iloc[j]['neighbour'])
    ...
    try:
        ...
        df6['neighbourhood'] = str(TehranNeighbourhoods.iloc[j]['neighbour'])
        df6['city'] = "tehran"
...
filename = 'SandroAutomatic-'+today.strftime("%d-%m-%y")+'.xlsx'
